...
<Prose {...props}>
	...
	<div class="content">
		<section>
			<h1>Chips</h1>
			<p>
				사람들이 정보를 입력하고, 선택을 하며, 콘텐츠를 필터링하거나 동작을 실행하는 데 도움을 줘요.
			</p>
			...
			<p>
				더 자세한 내용은
				<a target="_blank" href="https://m3.material.io/components/chips/overview">
					Metrial - Chips
				</a>와
				<a target="_blank" href="https://www.mdui.org/en/docs/2/components/chip"> MDUI - Chip </a>을
				참고해주세요.
			</p>
